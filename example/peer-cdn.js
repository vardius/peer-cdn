(function (global, factory) {
	...
	(factory((global['peer-cdn'] = global['peer-cdn'] || {})));
...
function getActivate(CURRENT_CACHES) {
...
function getFetch(CURRENT_CACHES, regex, peers) {
  var cacheResponse = function cacheResponse(request, response) {
  ...
  var getFromCache = function getFromCache(request) {
  ...
  var getFromPeer = function getFromPeer(request, response) {
    if (response) {
      return response;
    }
  ...
  var getFromNetwork = function getFromNetwork(request, response) {
    if (response) {
      return response;
    }
  ...
  var getArrayBufferResponse = function getArrayBufferResponse(request, response) {
  ...
  var fetchResponse = function () {
    var _ref = asyncToGenerator(regeneratorRuntime.mark(function _callee(request) {
      var cachedResponse, peerResponse, networkResponse, finalResponse;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              _context.next = 6;
              return getFromPeer(request, cachedResponse);

            case 6:
              peerResponse = _context.sent;
              _context.next = 9;
              return getFromNetwork(request, peerResponse);

            case 9:
              networkResponse = _context.sent;
              _context.next = 12;
              return getArrayBufferResponse(request, networkResponse);
            ...
            case 16:
              ...
              console.error("Fetching failed:", _context.t0);
...
var Peers = function () {
  function Peers() {
    classCallCheck(this, Peers);

    this.match = this.match.bind(this);
  }

  Peers.prototype.match = function match(request) {
...
var PeerCDN$1 = function () {
  ...
  PeerCDN.prototype.install = function install$$1() {
    return install;
  };

  PeerCDN.prototype.activate = function activate() {
    return getActivate(this.currentCaches);
  };

  PeerCDN.prototype.fetch = function fetch() {
    return getFetch(this.currentCaches, this.regex, this.peers);
  };

  PeerCDN.prototype.register = function register(sw) {
    [this.install()].forEach(function (handler) {
      return sw.addEventListener("install", handler);
    });

    [this.activate()].forEach(function (handler) {
      return sw.addEventListener("activate", handler);
    });
    ...
    [this.fetch()].forEach(function (handler) {
      return sw.addEventListener("fetch", handler);
    });
  };
...
self.PeerCDN = PeerCDN$1;

exports['default'] = PeerCDN$1;
