...
const fs = require("fs");
const PeerCdnServer = require("../src/server"); // require("peer-cdn/server")
...
// app.use("/peer-cdn", express.static(fspath.join(__dirname, "./node_modules/peer-cdn/dist")));
app.use("/peer-cdn", express.static(fspath.join(__dirname, "../dist")));
